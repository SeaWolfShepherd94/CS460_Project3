...
Comment::Comment() : _hash{'\0'}, _varExpression{nullptr} {}

Comment::Comment(char h, ExprNode *varExpr):
_hash{h}, _varExpression{varExpr} {}

void Comment::evaluate(SymTab &symTab) {
    std::cout << "#" << std::endl;
}

ExprNode *&Comment::varExpression() {
    return _varExpression;
}
